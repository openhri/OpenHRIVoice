...
target_url="http://en.sourceforge.jp/frs/redir.php?m=jaist&f=%2Fjulius%2F60416%2Fdictation-kit-v4.3.1-linux.tgz"
target_option1="-O"
target_option2="dictation-kit-v4.3.1-linux.tgz"
...
target_file="dictation-kit-v4.3.1-linux.tgz"

# Extrac archive.
func_extracFile $target_file $target_installPath

# Set to Symbolic link.
/usr/bin/sudo /bin/ln -s /usr/local/share/dictation-kit-v4.3.1-linux /usr/local/share/julius-runkit
